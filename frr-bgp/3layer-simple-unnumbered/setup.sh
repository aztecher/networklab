...
DOCKER_NETWORK_NAME_SHARED="shared"
...
DOCKER_NETWORK_SUBNET_SHARED=10.0.0.0/24
DOCKER_NETWORK_SUBNET_SHARED_DEFAULT_GW=10.0.0.1
...
echo "Creating simple FRR + BGP + Unnumbered Labo"

echo "Creating networks (netns) ..."
sudo docker network create ${DOCKER_NETWORK_NAME_SHARED} --subnet=${DOCKER_NETWORK_SUBNET_SHARED}
...
sudo docker network connect ${DOCKER_NETWORK_NAME_SHARED} leaf1
...
sudo docker network connect ${DOCKER_NETWORK_NAME_SHARED} leaf2
...
echo ""
echo "  [Leaf1(${leaf1_address})]------[BGP Unnumbered]-----[Leaf2(${leaf2_address})]"
echo "        |                                           |"
echo "        |                                           |"
