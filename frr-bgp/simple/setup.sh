...
alpine1_address=$(sudo docker inspect alpine1 | jq .[0].NetworkSettings.Networks.net1.IPAddress | tr -d '"')
alpine2_address=$(sudo docker inspect alpine2 | jq .[0].NetworkSettings.Networks.net3.IPAddress | tr -d '"')
